...
const About = () => {
  ...
  <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-purple-600/8 rounded-full blur-[100px]"></div>
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-3 bg-white/[0.08] backdrop-blur-md rounded-full px-6 py-3 mb-6 border border-white/[0.15]">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white/[0.05] backdrop-blur-md rounded-2xl p-8 md:p-12 mb-16 border border-white/[0.1]"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white/[0.08] backdrop-blur-md p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-white/[0.15] hover:border-white/[0.25]"
              >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gradient-to-r from-purple-600/80 via-fuchsia-600/80 to-purple-700/80 backdrop-blur-md rounded-2xl p-8 md:p-12 text-white border border-white/[0.2]"
        >
