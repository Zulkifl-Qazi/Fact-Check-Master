        ...
        >
          ...
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', background: 'rgba(88, 28, 135, 0.4)', borderRadius: '9999px', padding: '0.6rem 1.5rem', marginBottom: '1.5rem', border: '1px solid rgba(168, 85, 247, 0.4)' }}>
              <FaFileContract style={{ color: '#c4b5fd' }} />
          ...
          <div style={{ background: 'rgba(30, 41, 59, 0.7)', borderRadius: '1.25rem', padding: '2.5rem', border: '1px solid rgba(168, 85, 247, 0.2)', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', color: 'rgba(255,255,255,0.78)', lineHeight: '1.75', fontSize: '1rem' }}>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>1. Acceptance of Terms</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>2. Description of Service</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>3. Content & Disclaimer</h2>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>4. User Conduct</h2>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>5. Intellectual Property</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>6. Third-Party Content</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>7. Feedback & Submissions</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>8. Limitation of Liability</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>9. Modifications</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: 'white', marginBottom: '0.75rem' }}>10. Governing Law</h2>
                <p>
