                    ...
                    <div className="p-4 md:p-8">
                        ...
                        <div className="pt-8 mt-8 border-t border-slate-200/60 dark:border-slate-800/60">
                            <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4 flex items-center gap-2">
                                <FaShareAlt className="text-blue-600 dark:text-blue-500 text-base" />
                                Share This Fact Check
                            </h3>
                            <div className="flex flex-wrap gap-2.5">
                                <button
                                    onClick={() => handleShare('facebook')}
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-xl border-none cursor-pointer font-bold text-xs transition hover:-translate-y-0.5"
                                >
                                    <FaFacebook />
                                    Facebook
                                </button>
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#111827] dark:bg-slate-800 hover:bg-slate-800 dark:hover:bg-slate-700 text-white rounded-xl border-none cursor-pointer font-bold text-xs transition hover:-translate-y-0.5"
                                >
                                    <FaTwitter />
                                    X (Twitter)
                                </button>
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-xl border-none cursor-pointer font-bold text-xs transition hover:-translate-y-0.5"
                                >
                                    <FaWhatsapp />
                                    WhatsApp
                                </button>
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-xl border-none cursor-pointer font-bold text-xs transition hover:-translate-y-0.5"
                                >
                                    <FaLink />
                                ...
                                {navigator.share && (
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl border-none cursor-pointer font-bold text-xs transition hover:-translate-y-0.5"
                                    >
                                        <FaGlobe />
                                        Share options
                                    </button>
