        ...
        >
          ...
          <div style={{ background: '#ffffff', borderRadius: '1.25rem', padding: '2.5rem', border: '1px solid #e5e7eb', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', color: '#374151', lineHeight: '1.75', fontSize: '1rem' }}>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>1. Introduction</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>2. Information We Collect</h2>
                ...
                <ul style={{ paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', listStyleType: 'disc' }}>
                  <li><strong style={{ color: '#111827' }}>Contact Form Submissions:</strong> When you use our contact form, we collect your name, email address, subject, and message content to respond to your inquiry.</li>
                  <li><strong style={{ color: '#111827' }}>Device Information:</strong> We collect basic device fingerprint data to help manage access and prevent abuse of our platform.</li>
                  <li><strong style={{ color: '#111827' }}>Analytics Data:</strong> We use Vercel Analytics to collect anonymous usage data such as page views, browser type, and general location to improve our services.</li>
                </ul>
              </div>

              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>3. Cookies & Advertising</h2>
                <p style={{ marginBottom: '0.75rem' }}>
                  We use Google AdSense to display advertisements on our site. Google AdSense may use cookies and web beacons to serve ads based on your prior visits to our website or other websites on the Internet. You can opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" style={{ color: '#2563eb', textDecoration: 'underline' }}>Google's Ads Settings</a>.
                </p>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>4. Third-Party Embeds</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>5. How We Use Your Information</h2>
                <ul style={{ paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', listStyleType: 'disc' }}>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>6. Data Security</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>7. Data Retention</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>8. Your Rights</h2>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>9. Children's Privacy</h2>
                <p>
              ...
              <div>
                <h2 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#111827', marginBottom: '0.75rem' }}>10. Changes to This Policy</h2>
                <p>
